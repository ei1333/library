...
data:
  ...
  bundledCode: "#line 1 \"test/verify/aoj-2674-2.test.cpp\"\n#define PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=2674\"\
    ...
    \ int, 18 > matrix(X);\n  cin >> Q;\n  while(Q--) {\n    int L, R, E;\n    cin\
    \ >> L >> R >> E;\n    --L, --R;\n    cout << (R - L + 1) - matrix.range_freq(L,\
    \ R + 1, min(X[L], X[R]) - E, max(X[L], X[R]) + E + 1) << \"\\n\";\n  }\n}\n"
  code: "#define PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=2674\"\
    ...
    \  cin >> Q;\n  while(Q--) {\n    int L, R, E;\n    cin >> L >> R >> E;\n    --L,\
    \ --R;\n    cout << (R - L + 1) - matrix.range_freq(L, R + 1, min(X[L], X[R])\
    \ - E, max(X[L], X[R]) + E + 1) << \"\\n\";\n  }\n}\n"
  dependsOn:
  ...
  verifiedWith: []
documentation_of: test/verify/aoj-2674-2.test.cpp
layout: document
redirect_from:
- /verify/test/verify/aoj-2674-2.test.cpp
- /verify/test/verify/aoj-2674-2.test.cpp.html
