...
data:
  ...
  bundledCode: "#line 1 \"test/verify/yosupo-sharp-p-subset-sum.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/sharp_p_subset_sum\"\n\n#line 1 \"\
    ...
    \ MFP(F &&f) {\n  return FixPoint< F >{forward< F >(f)};\n}\n#line 4 \"test/verify/yosupo-sharp-p-subset-sum.test.cpp\"\
    ...
    \  }\n  return f.exp();\n}\n#line 8 \"test/verify/yosupo-sharp-p-subset-sum.test.cpp\"\
    \n\nconst int MOD = 998244353;\nusing mint = ModInt< MOD >;\n\nint main() {\n\
    \  int N, T;\n  cin >> N >> T;\n  vector< mint > c(T + 1);\n  for(int i = 0; i\
    \ < N; i++) {\n    int s;\n    cin >> s;\n    c[s] += 1;\n  }\n  auto ret = count_subset_sum<\
    \ FPS >(c);\n  ret.erase(begin(ret));\n  cout << ret << \"\\n\";\n}\n"
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/sharp_p_subset_sum\"\n\n\
    #include \"../../template/template.hpp\"\n\n#include \"../../math/combinatorics/mod-int.hpp\"\
    \n#include \"../../math/fps/formal-power-series-friendly-ntt.hpp\"\n#include \"\
    ../../math/fps/count-subset-sum.hpp\"\n\nconst int MOD = 998244353;\nusing mint\
    \ = ModInt< MOD >;\n\nint main() {\n  int N, T;\n  cin >> N >> T;\n  vector< mint\
    \ > c(T + 1);\n  for(int i = 0; i < N; i++) {\n    int s;\n    cin >> s;\n   \
...
layout: document
redirect_from:
- /verify/test/verify/yosupo-sharp-p-subset-sum.test.cpp
- /verify/test/verify/yosupo-sharp-p-subset-sum.test.cpp.html
