...
data:
  ...
  bundledCode: "#line 1 \"test/verify/yosupo-dominatortree.test.cpp\"\n#define PROBLEM\
...
layout: document
redirect_from:
- /verify/test/verify/yosupo-dominatortree.test.cpp
- /verify/test/verify/yosupo-dominatortree.test.cpp.html
