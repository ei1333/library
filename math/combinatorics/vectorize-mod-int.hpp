...
struct alignas(32) VectorizeModInt {
  ...
  inline VectorizeModInt(const i32 &v0, const i32 &v1, const i32 &v2,
                         const i32 &v3, const i32 &v4, const i32 &v5,
  ...
  static inline __m256i _mm256_mulhi_epi32(const __m256i &a,
    ...
    auto prod13 = _mm256_mul_epu32(_mm256_shuffle_epi32(a, 0xf5),
  ...
  Mints inline &operator+=(const Mints &p) {
    ...
    x            = _mm256_add_epi32(
        c, _mm256_and_si256(_mm256_cmpgt_epi32(m0, c), m2));
    return *this;
  }
